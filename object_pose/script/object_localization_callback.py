...
def image_color_callback(msg):
    ...
    if label == "clock":
        ...
        image_color = cv2.circle(image_color, center_coordinates, 2, (0,255,0), -1)

    elif label == "chair":

        image_color = cv2.circle(image_color, center_coordinates, 2, (0,0,255), -1)

    elif label == "person":

        image_color = cv2.circle(image_color, center_coordinates, 2, (255,0,0), -1)
